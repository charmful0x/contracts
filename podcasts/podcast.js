...
export async function handle(state, action) {
	...
	if ( input.function === "addEpisode") {
		...
		if (typeof audio !== "string" || audio.length !== 43) {
			throw new ContractError(`invalid audio TX type`)
		}
		...
		podcasts[podcastIndex]["episodes"].push({
...
//lhIkxHTm6H4zMyWJVugLUt3EJsQ7zeFyKMLCMToDt3s

//smartweave write cJ945o16PcyPWmxjWHJahP2yphTloWoV7oksz2ScaRk --key-file arweave-wallets/permaleaks-keyfile-main.json --input '{"function": "createPodcast", "name": "decent-land", "desc": "a better world, where DAOs take decisions", "cover": "lhIkxHTm6H4zMyWJVugLUt3EJsQ7zeFyKMLCMToDt3s"}'

//smartweave write cJ945o16PcyPWmxjWHJahP2yphTloWoV7oksz2ScaRk --key-file arweave-wallets/permaleaks-keyfile-main.json --input '{"function":"addEpisode", "index": 0, "podcast":"l0xoFBucr1uNxFJm5QYCYQlU74sK-uJx-e9hiyAdC4o","name":"Xylophon","audio":"9vRQ88yAaW3_LiTvVdgXYA_l7e-ZPUI5on8lv3AY_RU","desc": "a sound track from EpidemicSound"}'

 //smartweave write mvBG00Ccigq9htgOVCdAe9vXM8efbGzm8ax89NIlZS8 --key-file arweave-wallets/permaleaks-keyfile-main.json --input '{"function": "editEpisodeName","name": "xyzy" , "pid": "90L2HsJ5M-Lx7ff7hVbpaoG-L35YLtqOL4qrk55yDg4", "id":0}'

// smartweave create projects/ArweaveNews/podcasts/podcast.js projects/ArweaveNews/podcasts/podcast.json --key-file arweave-wallets/permaleaks-keyfile-main.json
// smartweave create projects/ArweaveNews/podcasts/podcast.js projects/ArweaveNews/podcasts/podcast.json --key-file arweave-wallets/permaleaks-keyfile-main.json
