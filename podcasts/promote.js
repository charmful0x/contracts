export async function handle (state, action) {
	...
	const WARN = "FdY68iYqTvA40U34aXQBBYseGmIUmLV-u57bT7LZWm0" // FCP protocol compatible PST
	// Errors
	...
	async function _validateDepositTransaction(txid, address) {
		...
		const fcpTxsValidation = await SmartWeave.contracts.readContractState(WARN, undefined, true)
	...
	function _validateStakingAttempt(address, qty, id) {
